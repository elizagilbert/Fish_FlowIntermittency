...
cypcar_is <- read.csv("FDA_Data/Coefs_Isleta_CYPCAR_CHNG.csv")%>% 
  mutate(Time = as.Date(Time, origin="1970-01-01"))
...
plot_grid(pl_ict_san_a, pl_cypcar_is, pl_pim_is, pl_gam_is, pl_cyp_is)
dev.off()
